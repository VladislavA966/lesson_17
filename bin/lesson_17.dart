...
void main() {
  Employee vlad = Employee(name: 'Vlad', salary: 400);
  Manager sasha = Manager(bonus: 600, name: 'Sasha', salary: 800);
  Developer aidar = Developer(language: 'Flutter', name: 'Aidar', salary: 1500);
